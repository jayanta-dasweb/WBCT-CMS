...
<head>
    ...
    <title>WBCT-CMS | Admin-Pending Complaints</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  ?>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./pendingComplaints.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">All Pending Complaints</h3>
    ...
    <script src="js/pendingComplaintsMain.js"></script>
    <script src="js/pendingComplaintsFun.js"></script>

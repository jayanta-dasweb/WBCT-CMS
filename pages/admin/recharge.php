...
<head>
    ...
    <title>WBCT-CMS | Admin-Recharge</title>
    ...
    <link rel="stylesheet" href="css/rechargeStyle.css">
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  ?>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="./recharge.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Recharge
                                        </p>
                                    </a>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <!-- FORM -->
                    <div class="card card-default mt-3 mb-2" id="pkgSelectSection">
                        ...
                        <div class="card-body">
                            ...
                            <div class="w-100 d-flex align-items-center justify-content-end mt-2">
                                <button type="submit" class="btn btn-primary" onclick="finalSubmitData()">Submit</button>
                            </div>
                        </div>
                        <!-- FORM END -->
                        <!-- Container-fluid END -->
    ...
    <script src="js/rechargeMain.js"></script>
    <script src="js/rechargeFun.js"></script>

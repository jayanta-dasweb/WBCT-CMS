...
<head>
    ...
    <title>WBCT-CMS | Admin-Add Employee</title>
    ...
    <link rel="stylesheet" href="css/addEmpStyle.css">
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  ?>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./addEmp.php" class="nav-link active">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="updateModalLabel">Edit & Update Data</h5>
                                                            ...
                                                            <div class="col-md">
                                                                <div class="form-floating">
                                                                    <input type="text" class="form-control" id="phno"
                                                                        name="phno" placeholder="8876XXXXXX">
                                                                    <label for="floatingInputGrid">Ph Number</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <form class="row g-3" id="addDataForm">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="inputPh" placeholder="887607XXXX"
                                            name="inputPh">
                                        <label for="inputPh">Enter Ph Number</label>
                                    </div>
                                </div>
                            </form>
                            <div class="col-12 d-flex align-items-center justify-content-end">
                                <button type="submit" class="btn btn-sm btn-primary" onclick="addData()">Submit</button>
                            </div>
                            <!-- /.row -->
                        </div>
                        <!-- FORM END -->
    ...
    <script src="js/addEmpMain.js"></script>
    <script src="js/addEmpFun.js"></script>

...
<head>
    ...
    <title>WBCT-CMS | Admin-Recharge Pending Request</title>
    ...
    <link rel="stylesheet" href="css/rechrgPendingReqstStyle.css">
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  ?>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./rechrgPendingReqst.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Pending Request
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Pending Recharge Request</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">All Recharge Request</h3>
                                ...
                                <div class="modal fade" id="payDetailsModal" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" id="payDetArea">
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="js/rechrgPendingReqstMain.js"></script>
    <script src="js/rechrgPendingReqstFun.js"></script>

...
<head>
    ...
    <title>WBCT-CMS | Admin-Pending Connection Request</title>
    ...
    <link rel="stylesheet" href="css/pendingConnRequestStyle.css">
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  ?>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./pendingConnRequest.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Pending Request
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Pending Connection Request</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">All Pending Connection Request</h3>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="acceptModalLabel">Approve Connection
                                                </h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close" onclick="closeBtn()"></button>
                                            </div>
                                            <div class="modal-body w-100">
                                                <form id="acceptConnectionForm" class="w-100">
                                                    <input type="hidden" id="hiddenConnId">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="floatingInputForSTBNO"
                                                            placeholder="N810007XXXXX" onkeyup="capitalizeText()">
                                                        <label for="floatingInputForSTBNO">Enter STB Number</label>
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary" onclick="finalAccept()">Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="js/pendingConnRequestMain.js"></script>
    <script src="js/pendingConnRequestFun.js"></script>

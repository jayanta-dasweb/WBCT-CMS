...
<head>
  ...
  <title>WBCT-CMS | Admin-Home</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
          ...
          <div class="row">
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-info">
                ...
                <a href="./allCust.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-success">
                <div class="inner">
                  <h3 id="totalActiveConnection"></h3>
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-warning">
                <div class="inner">
                  <h3 id="totalPendingComplaints"></h3>
                ...
                <a href="./pendingComplaints.php" class="small-box-footer">More info <i
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-danger">
                <div class="inner">
                  <h3 id="totalPendingConnectionRequest"></h3>
                ...
                <a href="./pendingConnRequest.php" class="small-box-footer">More info <i
                    class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
  ...
  <script src="js/homeFun.js"></script>

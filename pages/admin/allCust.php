...
<head>
    ...
    <title>WBCT-CMS | Admin-All Customer</title>
    ...
    <link rel="stylesheet" href="css/allCustStyle.css">
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  ?>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./allCust.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>All Customer
                                        </p>
                                    </a>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <!-- /******************** Modal For Conn Details *********/ -->
                                <div class="modal fade" id="connDetailsModal" tabindex="-1"
                                    aria-labelledby="connDetailsModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="connDetailsModalLabel">Connection Details
                                                </h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body" class="p-3">
                                                <div class="w-100" id="connDet">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <!-- /******************** Modal For Conn Details End *********/ -->

                                <!-- /********************* Edit & update cust data Modal *********/ -->
                                <div class="modal fade" id="editDataModal" tabindex="-1"
                                    aria-labelledby="editDataModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="editDataModalLabel">Edit And Update Data
                                                </h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form id="updateForm" class="w-100 row g-3">
                                                    <input type="hidden" id="hiddenCustId" value=0 name="id">
                                                    <div class="col-md-6">
                                                        <div class="form-floating">
                                                            <input type="text" class="form-control"
                                                                id="floatingInputForName" placeholder="john" name = "name">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-floating">
                                                            <input type="email" class="form-control"
                                                                id="floatingInputForEmail" placeholder="john@gmail.com" name = "email" value = "NULL">
                                                            <label for="floatingInputForEmail">E-mail</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-floating">
                                                            <input type="text" class="form-control"
                                                                id="floatingInputForPhNo" placeholder="8876XXXXXX" name="phno">
                                                            <label for="floatingInputForPhNo">Contact Number</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-floating">
                                                            <input type="number" class="form-control"
                                                                id="floatingInputForHNo" placeholder="e.g. 16" name="hno">
                                                            <label for="floatingInputForHNo">House Number</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-floating">
                                                            <select class="form-select" id="floatingSelectForArea"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-floating">
                                                            <input type="number" class="form-control"
                                                                id="floatingInputForPinCode" placeholder="781009" name="pincode">
                                                            <label for="floatingInputForPinCode">Pin Code</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-floating">
                                                            <input type="text" class="form-control"
                                                                id="floatingInputForStbNo" placeholder="N8000XXXXXXX" name="stbno"
                                                                onkeyup="capitalizeText()">
                                                            <label for="floatingInputForStbNo">STB Number</label>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                ...
                                <!-- /********************* Edit & update cust data Modal End *********/ -->
    ...
    <script src="js/allCustMain.js"></script>
    <script src="js/allCustFun.js"></script>

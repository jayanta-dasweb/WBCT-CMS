...
<head>
    ...
    <title>WBCT-CMS | Admin-Resolve Complaints</title>
    ...
    <link rel="stylesheet" href="css/pendingComplaintsStyle.css">
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  ?>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="./resolveComplaints.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Resolve Complaints</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">All Resolved Complaints</h3>
                                ...
                                <div class="modal fade" id="showComplaintModal" tabindex="-1"
                                    aria-labelledby="showComplaintModalLabel" aria-hidden="true">
    ...
    <script src="js/resolveComplaintsMain.js"></script>
    <script src="js/resolveComplaintsFun.js"></script>

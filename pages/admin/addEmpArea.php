...
<head>
    ...
    <title>WBCT-CMS | Admin-Add Employee Area</title>
    ...
    <link rel="stylesheet" href="css/addEmpAreaStyle.css">
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  ?>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="./addEmpArea.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Add Employee Area</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <div class="container-fluid">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">All Employee (With Area)</h3>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="updateModalLabel">Edit & Update Data
                                                </h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close" onclick="closeUpdateModal()"></button>
                                            </div>
                                            <div class="modal-body">
                                                <div
                                                    ...
                                                    <form id="updateForm">
                                                        ...
                                                        <div class="row g-2">
                                                            <div class="col-lg-12">
                                                                <div class="form-floating dataSelectForUpdate">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                                                <div class="form-floating">
                                                                    <input type="text" class="form-control editArea"
                                                                        id="floatingText"
                                                                        placeholder="e.g. Machkhow F.A. Road">
                                                                    <label for="floatingText">Area</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-sm btn-primary"
                                                    onclick="finalUpdateData()">Update</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div
                                                    class="container-fluid d-flex align-items-center justify-content-center">
                                                    <form id="deleteForm">
                                                        <input type="hidden" value=0 id="hiddenId2">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="form-floating dataSelectForDelete">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Assign Area To Employees</h3>
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form class="row g-3" id="addDataForm">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control addArea" id="floatingText"
                                            placeholder="e.g. Machkhow F.A. Road">
                                        <label for="floatingPassword">Enter Area</label>
                                    </div>
                                </div>
                            </form>
    ...
    <script src="js/addEmpAreaMain.js"></script>
    <script src="js/addEmpAreaFun.js"></script>

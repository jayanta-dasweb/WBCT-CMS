...
<head>
    ...
    <title>WBCT-CMS | Admin-Create Package</title>
    ...
    <link rel="stylesheet" href="css/addPkgStyle.css">
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  ?>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./addPkg.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add Packages</p>
                                    </a>
                                </li>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">All Packegs</h3>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-floating">
                                                                    <input type="text" class="form-control"
                                                                        id="floatingPkgNameUpdate" placeholder="e. g. Sports">
                                                                    <label for="floatingPkgNameUpdate">Package Name</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <form class="row g-3" id="addDataForm">
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="floatingPkgName"
                                            placeholder="e. g. Sports">
                                        <label for="floatingPkgName">Package Name</label>
                                    </div>
                                </div>
                            </form>
    ...
    <script src="js/addPkgMain.js"></script>
    <script src="js/addPkgFun.js"></script>

          ...
          <ul>
            ...
            <li class="dropdown" style="cursor:pointer">
              ...
              <ul>
                ...
                <li><a href="./recharge.php" class="nav-link active" id="rechrgPg">Recharge</a></li>
            ...
            <div class="card">
              ...
              <div class="card-body" id="cardBodyTable">
                ...
                <div class="w-100 d-flex align-items-center justify-content-end mt-2">
                  <button type="submit" class="btn btn-success" onclick="finalSubmitData()">Proceed To Pay</button>
                </div>
              </div>
            </div>

...
<body>
          ...
          <ul>
            ...
            <li class="dropdown" style="cursor:pointer">
              ...
              <ul>
                ...
                <li><a href="./rechrgHistory.php" class="nav-link active">View History</a></li>
              </ul>
            </li>
            <li class="dropdown" style="cursor:pointer">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8">
            <div class="card">
              ...
              <!-- /**************** Get payment details *********/ -->
              <div class="modal fade" id="payDetailsModal" tabindex="-1" aria-labelledby="payDetailsModalLabel"
                aria-hidden="true">
  ...
  <script src="./js/rechargeHistory.js"></script>

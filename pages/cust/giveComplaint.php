...
<body>
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li class="dropdown" style="cursor:pointer">
              ...
              <ul>
                <li><a href="./giveComplaint.php" class="nav-link active">Give Complaint</a></li>
              ...
              <div class="card-body">
                <form id="complaintForm">
                  <div class="form-floating mb-3">
                    <input type="email" class="form-control" id="floatingInputForSubject" placeholder="subject">
                    <label for="floatingInputForSubject">Subject</label>
                  </div>
                  <div class="form-floating">
                    <textarea class="form-control" maxlength="1000" placeholder="Leave your coplaint here"
                      id="floatingTextareaForDes" style="height: 100px"></textarea>
                    <label for="floatingTextareaForDes">Description</label>
                  </div>
                </form>
                <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-3">
                  <button class="btn btn-success" type="button" onclick="submitData()">Submit</button>
                </div>
              </div>
            </div>
  ...
  <script src="./js/giveComplaint.js"></script>
